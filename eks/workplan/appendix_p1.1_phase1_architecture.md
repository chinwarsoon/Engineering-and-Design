...
- **Deliverable checklist**: Consolidated into [p1_sc_log.md](../log/phase1/p1_sc_log.md) — 349-item success criteria superseding original 114 items.
- **Component mapping**: Consolidated into [§7 Issues & Fixes](#7-issues--fixes--summary-with-cross-references) — all component mappings now included in the cross-reference table.
...
> **Consolidated reference.** All 13 Phase 1 defect fixes with links to `../log/phase1/p1_issue_log.md` for full details (root cause, fix description, outcome).

| # | Issue ID | Title | Related Design § | Issue Log Link |
|:---:|:---|:---|:---|:---|
| 1 | I130 | Bootstrap Path-Resolution Rooting | [§4.3](#43-path-resolution--system-parameters), [Appx H](appendix_h_bootstrap_module_design.md) | [`issue_log.md`](../log/phase1/p1_issue_log.md) |
| 2 | I131 | KeyError: 'revision' in register_placeholders | [§3.2](#912-file-scanner-eksenginecorefile_scannerpy), [§5.1](#51-the-parser-interface-baseparser) | [`issue_log.md`](../log/phase1/p1_issue_log.md) |
| 3 | I132 | .dwg File Type Orphan | [§1.3](#13-module-inventory), [§5.3](#53-schema-driven-discovery-ssot) | [`issue_log.md`](../log/phase1/p1_issue_log.md) |
| 4 | I133–I163 | Unified P-Prefix Error Codes + Filename Parser | [§6.6](#66-error--message-schemas), [Appx D](appendix_d_pipeline_messages_errors.md), [Appx I](appendix_i_filename_parser.md) | [`issue_log.md`](../log/phase1/p1_issue_log.md) |
| 5 | I164–I168 | Document Metadata Schema Gaps | [§6.4](#64-document-schema-v2), [Appx B](appendix_b_document_registry.md) | [`issue_log.md`](../log/phase1/p1_issue_log.md) |
...
| 1.1 | 2026-07-20 | CodeBuddy | Relocated full Project Folder Structure tree from main workplan §11 into §1; §11 now a stub pointing here. Added T1.1 scaffolding notes and cross-references to §10, §14. P1-B/P1-D retired — content consolidated into §7 / p1_sc_log.md. |
| 1.0 | 2026-07-20 | CodeBuddy | Initial full blueprint: populated all 5 sections with cross-references to main workplan §9–§30, general appendices A–J, and P1-specific appendices P1-B/P1-C/P1-D. P1-B/P1-D now retired — their content migrated to §7 / p1_sc_log.md. |
