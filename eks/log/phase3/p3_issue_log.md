...
| I228 | 2026-07-20 | Phase 1 | 🟠 High | Asset schema (Appendix A) has zero runtime pipeline integration | eks_asset schemas exist and validate. No pipeline phase loads asset data, applies fragment composition, or validates records. | 🔴 Open | — | Close: Phase 3 plans asset loaders. Phase 1 has no asset extraction engine — risks Phase 3 being blocked. Phase 1.2 de-risking spike I318 (T1.309–T1.312) proposed 2026-08-18; T3.9 acceptance now includes I020 column-coverage pre-check + I021 null tolerance (see p1_issue_log.md). |
