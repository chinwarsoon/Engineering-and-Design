...
# Add engine root to path so submodules resolve without 'tracer.' prefix
...
from utils.trace_filters import format_trace_for_display
from utils.trace_filters import should_trace_file, filter_trace_data
...
async def run_pipeline(run_data: dict):
    ...
    try:
        ...
        # Import the runner
        from pipeline_sandbox.runner import load_and_trace_script
...
async def static_analyze(req: dict):
    ...
    try:
        ...
        from static.crawler import crawl
        from static.parser import parse_all
        from static.graph import CallGraph
